...
- **Edges:** บันทึกความสัมพันธ์เชิงทิศทาง (Directional Edges) เช่น `Calls`, `Imp  orts`, `Inherits`, `Routes_To`
...
- **Persistance Format:** จัดเก็บในรูปแบบ Optimized Binary (LadybugDB) และรองรับ  การ Export เป็น JSONL สำหรับการ Audit

## 4. Query Capability

- รองรับ **OpenCypher** ในการ Query ความสัมพันธ์แบบ Graph
- รองรับการทำ **Deep Traversal** เพื่อติดตาม Execution Flow จาก Entry Point ไปยั  ง Leaf Node
- รองรับ **Bi-temporal time-travel** เพื่อดูสถานะของ Graph ณ เวลาใดเวลาหนึ่งในอด  ีต
