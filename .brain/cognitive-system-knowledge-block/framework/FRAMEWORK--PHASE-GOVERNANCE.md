...
| Phase  | Activity                               | Documentation                                         | Block (In document) | Diagram | Devlog ID               |
| --- | --- | --- | --- | --- | --- |
| **P0** | Frame the universe                     | `IDEA--`,`CONCEPT--`,`INSIGH--`,`GOAL--`                            |                           |         | —`MSP-CON-`             |
| **P1** | Define business need + technical draft | `ALGO--`,`PRD--`,`FRAME--`,`BRD--`                                  | `FR--`,`NFR--`,`REQ--`    |         | `MSP-CON-`              |
| **P2** | Design structure + API spec            | `ROADMAP--`,`TDD--`, `ENTITY--`, `API--`, `FEAT--`,`FLOW--`,`MOD--` | `SPRINT--`,`AC--`,`SC--`   |         | `MSP-DES-`              |
...
| P7     | Acceptance test + walkthrough          | `AUDIT--`,BENCH--                                                   |                           |         | `MSP-WKT-`,`MSP-BENCH-` |
|        |                                        |                                                                     |                           |         |                         |
