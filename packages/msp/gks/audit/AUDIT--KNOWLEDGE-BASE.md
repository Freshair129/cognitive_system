...
| Spec section | Atoms |
|---|---|
| §2 Architecture | `FRAME--MSP-ARCHITECTURE-V2` |
| §3 Inbound flow | `CONCEPT--INBOUND-QUEUE`, `CONCEPT--SUBMISSION-ENVELOPE`, `CONCEPT--PROPOSAL-TYPES`, `ADR--PROMOTION-WORKFLOW` |
| §4 Atomic write contract | `CONCEPT--ATOMIC-WRITE-CONTRACT`, `ADR--FORBIDDEN-FIELDS-LIST`, `ADR--ANTI-HALLUCINATION-RULES`, `CONCEPT--EPISTEMIC-METADATA`, `FRAME--CROSSLINKS-VOCABULARY` |
...
| §6 Phase governance | `FRAME--PHASE-GOVERNANCE`, `FRAME--SCALING-LEVELS` |
...
| §13 Authority matrix | `FRAME--AUTHORITY-MATRIX` |
...
- `FRAME--MSP-ARCHITECTURE-V2` (root of the knowledge tree)
